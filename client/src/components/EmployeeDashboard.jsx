    ...
    <div className="animate-fade-in">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          {emp?.position} - {emp?.departement || "No Department"}
        </p>
      </div>
          ...
          >
            ...
            <card.icon
              className="size-10 p-2.5 rounded-lg bg-slate-100
                text-slate-600 group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors
                duration-200"
            />
          </div>
        ))}
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          to="/attendance"
          className="btn-primary text-center inline-flex
        ...
        <Link
          to="/leave"
          className="btn-secondary text-center inline-flex
        items-center justify-center gap-2"
        >
