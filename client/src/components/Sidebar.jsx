...
const Sidebar = () => {
  ...
  const sidebarContent = (
    <>
            ...
            >
              ...
              <item.icon
                className={`w-4.25 h-4.25 shrink-0 ${
                  isActive ? "text-indigo-300 ml-2" : "text-slate-400"
      ...
      <div className="p-3 border-t border-white/6">
        ...
        rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all
        duration-150"
        >
  ...
  return (
    <>
      ...
      from bg-slate-900 via-slate-900 to-slate-950 text-white shrink-0 border-r border-white/4"
      >
        {sidebarContent}
      </aside>
      ...
      {/* Sidebar - mobile */}
      <aside
        className={`lg:hidden fixed inset-y-0 left-0 w-72 bg-linear-to-r from-slate-900
